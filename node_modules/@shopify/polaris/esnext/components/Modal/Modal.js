...
export class Modal extends React.Component {
    ...
    render() {
        ...
        const { children, title, src, iFrameName, open, instant, sectioned, loading, large, limitHeight, onClose, footer, primaryAction, secondaryActions, polaris: { intl }, } = this.props;
        ...
        if (open) {
          ...
          <Spinner />
            ...
            const bodyMarkup = src ? (<iframe name={iFrameName} title={iframeTitle} src={src} className={styles.IFrame} onLoad={this.handleIFrameLoad} style={{ height: `${iframeHeight}px` }}/>) : (<Scrollable shadow className={styles.Body}>
          {body}
        </Scrollable>);
...
tslib_1.__decorate([
    autobind
], Modal.prototype, "handleEntered", null);
tslib_1.__decorate([
    autobind
], Modal.prototype, "handleExited", null);
tslib_1.__decorate([
    autobind
], Modal.prototype, "handleIFrameLoad", null);
