...
export class ResourceList extends React.Component {
    ...
    componentDidUpdate({ loading: prevLoading, items: prevItems }) {
    ...
    render() {
        ...
        <Button disabled={selectMode} icon={selectIcon} 
        ...
        const emptyStateMarkup = filterControl && !this.itemsExist() && !loading ? (<div className={styles.EmptySearchResultWrapper}>
...
tslib_1.__decorate([
    autobind
], ResourceList.prototype, "bulkSelectState", null);
tslib_1.__decorate([
    autobind
], ResourceList.prototype, "headerTitle", null);
tslib_1.__decorate([
    autobind
], ResourceList.prototype, "bulkActionsLabel", null);
tslib_1.__decorate([
    autobind
], ResourceList.prototype, "bulkActionsAccessibilityLabel", null);
tslib_1.__decorate([
    autobind
], ResourceList.prototype, "paginatedSelectAllText", null);
tslib_1.__decorate([
    autobind
], ResourceList.prototype, "paginatedSelectAllAction", null);
tslib_1.__decorate([
    debounce(50),
    autobind
], ResourceList.prototype, "handleResize", null);
tslib_1.__decorate([
    autobind
], ResourceList.prototype, "setLoadingPosition", null);
tslib_1.__decorate([
    autobind
], ResourceList.prototype, "handleSelectAllItemsInStore", null);
tslib_1.__decorate([
    autobind
], ResourceList.prototype, "renderItem", null);
tslib_1.__decorate([
    autobind
], ResourceList.prototype, "handleSelectionChange", null);
tslib_1.__decorate([
    autobind
], ResourceList.prototype, "handleSelectMode", null);
tslib_1.__decorate([
    autobind
], ResourceList.prototype, "handleToggleAll", null);
