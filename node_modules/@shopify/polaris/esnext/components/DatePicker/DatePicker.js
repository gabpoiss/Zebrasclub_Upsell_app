...
export class DatePicker extends React.PureComponent {
    ...
    render() {
        ...
        <div className={styles.Header}>
          <Button plain icon="arrowLeft" accessibilityLabel={intl.translate('Polaris.DatePicker.previousMonth', {
            previousMonthName,
            showPreviousYear,
        })} 
        // eslint-disable-next-line react/jsx-no-bind
        onClick={this.handleMonthChangeClick.bind(null, showPreviousMonth, showPreviousYear)}/>
          <Button plain icon="arrowRight" accessibilityLabel={intl.translate('Polaris.DatePicker.nextMonth', {
            nextMonth,
            nextYear,
        })} 
        // eslint-disable-next-line react/jsx-no-bind
...
tslib_1.__decorate([
    autobind
], DatePicker.prototype, "handleFocus", null);
tslib_1.__decorate([
    autobind
], DatePicker.prototype, "resetFocus", null);
tslib_1.__decorate([
    autobind
], DatePicker.prototype, "handleKeyUp", null);
tslib_1.__decorate([
    autobind
], DatePicker.prototype, "setFocusDateAndHandleMonthChange", null);
tslib_1.__decorate([
    autobind
], DatePicker.prototype, "handleDateSelection", null);
tslib_1.__decorate([
    autobind
], DatePicker.prototype, "handleMonthChangeClick", null);
tslib_1.__decorate([
    autobind
], DatePicker.prototype, "handleHover", null);
