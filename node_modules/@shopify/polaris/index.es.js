...
import { autobind, debounce, memoize } from '@shopify/javascript-utilities/decorators';
...
function () {
  ...
  _createClass(Intl, [{
    ...
    value: function setTranslation(translation) {
      var i18n = Array.isArray(translation) ? merge.apply(void 0, [{}].concat(_toConsumableArray(translation))) : translation;
...
__decorate([autobind], Intl.prototype, "translate", null);
...
function compose$1() {
  ...
  return fns.reduce(function (func$$1, group) {
    return function () {
      return func$$1(group.apply(void 0, arguments));
    };
  });
}
...
__decorate([autobind], ThemeProvider.prototype, "subscribe", null);

__decorate([autobind], ThemeProvider.prototype, "unsubscribe", null);
  ...
  _createClass(StickyManager, [{
    ...
    value: function manageStickyItems() {
      ...
      this.stickyItems.forEach(function (stickyItem) {
        ...
        var _this$evaluateStickyI = _this.evaluateStickyItem(stickyItem, scrollTop, containerTop),
            sticky = _this$evaluateStickyI.sticky,
            top = _this$evaluateStickyI.top,
            left = _this$evaluateStickyI.left,
            width = _this$evaluateStickyI.width;
...
__decorate([throttle(40), autobind], StickyManager.prototype, "handleResize", null);

__decorate([throttle(40), autobind], StickyManager.prototype, "handleScroll", null);
...
function createAppProviderContext() {
  var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      ...
      subscribe = _ref$subscribe === void 0 ? noop : _ref$subscribe,
      _ref$unsubscribe = _ref.unsubscribe,
      unsubscribe = _ref$unsubscribe === void 0 ? noop : _ref$unsubscribe;

  var intl = new Intl(i18n);
  var link = new Link(linkComponent);
  var appBridge = apiKey && !isServer ? createApp({
    apiKey: apiKey,
  ...
  return function addProvider(WrappedComponent) {
    ...
    function (_React$Component) {
      ...
      function WithProvider() {
        ...
        return _possibleConstructorReturn(this, _getPrototypeOf(WithProvider).apply(this, arguments));
      }
      ...
      _createClass(WithProvider, [{
        ...
        value: function handleContextUpdate() {
          this.forceUpdate();
        }
      }]);
    ...
    __decorate([autobind], WithProvider.prototype, "handleContextUpdate", null);
...
__decorate([autobind], AppProvider.prototype, "subscribe", null);

__decorate([autobind], AppProvider.prototype, "unsubscribe", null);
...
__decorate([autobind], Avatar.prototype, "handleError", null);

__decorate([autobind], Avatar.prototype, "handleLoad", null);
...
function compose$2() {
  ...
  return function wrapComponent(OriginalComponent) {
    var Result = compose.apply(void 0, wrappingFunctions)(OriginalComponent);
...
function Icon(_ref) {
  ...
  if (source === 'placeholder') {
    ...
    var iconSource = typeof source === 'string' && isBundledIcon(source) ? BUNDLED_ICONS[source] : source;
    contentMarkup = iconSource && iconSource.viewBox && iconSource.body && createElement("svg", {
...
function Button$1(_ref) {
  ...
  var className = classNames$1(styles$3.Button, primary && styles$3.primary, outline && styles$3.outline, destructive && styles$3.destructive, isDisabled && styles$3.disabled, loading && styles$3.loading, plain && styles$3.plain, monochrome && styles$3.monochrome, size && size !== DEFAULT_SIZE && styles$3[variationName$1('size', size)], fullWidth && styles$3.fullWidth, icon && children == null && styles$3.iconOnly);
  var disclosureIconMarkup = disclosure ? createElement(IconWrapper, null, createElement(Icon$1, {
    source: loading ? 'placeholder' : 'caretDown'
  })) : null;
  var iconMarkup;
...
function isIconSource(x) {
  return typeof x === 'string' || _typeof(x) === 'object' && x.body;
}
...
function buttonFrom(_a, overrides, key) {
  ...
  return createElement(Button$2, Object.assign({
    key: key,
    onClick: onAction
...
function Header(_ref) {
  ...
  var actionMarkup = actions ? createElement(ButtonGroup$1, null, buttonsFrom(actions, {
    plain: true
  })) : null;
...
function (_React$PureComponent) {
  ...
  _createClass(Card, [{
    ...
    value: function render() {
      ...
      var headerMarkup = title ? createElement(Header, {
        actions: actions,
        title: title
      }) : null;
      ...
      }, createElement(ButtonGroup$1, null, secondaryFooterActionMarkup, primaryFooterActionMarkup)) : null;
      return createElement("div", {
        className: className
...
__decorate([autobind], Scrollable.prototype, "setScrollArea", null);

__decorate([autobind], Scrollable.prototype, "handleScroll", null);

__decorate([autobind, debounce(50, {
  trailing: true
})], Scrollable.prototype, "handleResize", null);

__decorate([autobind], Scrollable.prototype, "scrollHint", null);

__decorate([autobind], Scrollable.prototype, "scrollStep", null);

__decorate([autobind], Scrollable.prototype, "scrollToPosition", null);
...
function Item$2(_ref) {
  var id = _ref.id,
      ...
      active = _ref.active,
      role = _ref.role;
  var className = classNames$1(styles$f.Item, disabled && styles$f.disabled, destructive && styles$f.destructive, active && styles$f.active);
...
__decorate([autobind], Option.prototype, "handleClick", null);

__decorate([autobind], Option.prototype, "toggleFocus", null);
  ...
  _createClass(OptionList, [{
    ...
    value: function render() {
      ...
      var _this$props2 = this.props,
          ...
          optionRole = _this$props2.optionRole;
...
__decorate([autobind], OptionList.prototype, "handleClick", null);
...
function (_React$Component) {
  ...
  function KeypressListener() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(KeypressListener).apply(this, arguments));
  }
...
__decorate([autobind], KeypressListener.prototype, "handleKeyEvent", null);
...
function (_React$PureComponent) {
  ...
  _createClass(PositionedOverlay, [{
    ...
    value: function componentDidUpdate() {
      var _this$state = this.state,
          outsideScrollableContainer = _this$state.outsideScrollableContainer,
          top = _this$state.top;
      var _this$props = this.props,
    ...
    value: function overlayDetails() {
      var _this$state3 = this.state,
          ...
          positioning = _this$state3.positioning,
          height = _this$state3.height,
          activatorRect = _this$state3.activatorRect;
      return {
        measuring: measuring,
        left: left,
    ...
    value: function handleMeasurement() {
      ...
      var _this$state4 = this.state,
          lockPosition = _this$state4.lockPosition,
      ...
      this.setState({
        ...
        var _this2$props = _this2.props,
            activator = _this2$props.activator,
            _this2$props$preferre = _this2$props.preferredPosition,
            preferredPosition = _this2$props$preferre === void 0 ? 'below' : _this2$props$preferre,
            _this2$props$preferre2 = _this2$props.preferredAlignment,
            preferredAlignment = _this2$props$preferre2 === void 0 ? 'center' : _this2$props$preferre2,
            onScrollOut = _this2$props.onScrollOut,
            fullWidth = _this2$props.fullWidth,
            fixed = _this2$props.fixed;
        ...
        var overlayMargins = _this2.overlay.firstElementChild ? getMarginsForNode(_this2.overlay.firstElementChild) : {
          activator: 0,
          container: 0,
          horizontal: 0
        };
...
__decorate([autobind], PositionedOverlay.prototype, "overlayDetails", null);

__decorate([autobind], PositionedOverlay.prototype, "setOverlay", null);

__decorate([autobind], PositionedOverlay.prototype, "handleMeasurement", null);
...
function (_React$PureComponent) {
  ...
  _createClass(PopoverOverlay, [{
    ...
    value: function renderPopover(transitionStatus, overlayDetails) {
      ...
      var className = classNames(styles$j.Popover, transitionStatus && animationVariations(transitionStatus), positioning === 'above' && styles$j.positionedAbove, fullWidth && styles$j.fullWidth, measuring && styles$j.measuring);
...
__decorate([autobind], Popover.prototype, "handleClose", null);

__decorate([autobind], Popover.prototype, "setActivator", null);
  ...
  _createClass(Resizer, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          minimumLines = _this$props.minimumLines;
    ...
    value: function handleHeightCheck() {
      ...
      var _this$props2 = this.props,
          currentHeight = _this$props2.currentHeight,
  ...
  _createClass(TextField, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          label = _this$props.label,
          labelAction = _this$props.labelAction,
          labelHidden = _this$props.labelHidden,
          ...
          ariaOwns = _this$props.ariaOwns,
          ariaActiveDescendant = _this$props.ariaActiveDescendant,
          ariaAutocomplete = _this$props.ariaAutocomplete,
          ariaControls = _this$props.ariaControls,
          showCharacterCount = _this$props.showCharacterCount,
          intl = _this$props.polaris.intl;
      ...
      var spinnerMarkup = type === 'number' && !disabled ? createElement(Spinner$2, {
      ...
      var inputClassName = classNames(styles$p.Input, suffix && styles$p['Input-suffixed']);
      ...
      return createElement(Labelled, {
        ...
        onBlur: this.handleBlur,
        onClick: this.handleClick
      }, prefixMarkup, input, suffixMarkup, characterCountMarkup, spinnerMarkup, createElement("div", {
    ...
    value: function handleNumberChange(steps) {
      var _this$props2 = this.props,
          ...
          min = _this$props2$min === void 0 ? -Infinity : _this$props2$min,
          _this$props2$max = _this$props2.max,
          max = _this$props2$max === void 0 ? Infinity : _this$props2$max;
    ...
    value: function handleButtonPress(onChange) {
      var _this2 = this;
      ...
      var onChangeInterval = function onChangeInterval() {
        ...
        onChange();
        _this2.buttonPressTimer = window.setTimeout(onChangeInterval, interval);
      };
    ...
    value: function handleButtonRelease() {
...
__decorate([autobind], TextField.prototype, "setInput", null);

__decorate([autobind], TextField.prototype, "handleNumberChange", null);

__decorate([autobind], TextField.prototype, "handleExpandingResize", null);

__decorate([autobind], TextField.prototype, "handleKeyPress", null);

__decorate([autobind], TextField.prototype, "handleChange", null);

__decorate([autobind], TextField.prototype, "handleFocus", null);

__decorate([autobind], TextField.prototype, "handleBlur", null);

__decorate([autobind], TextField.prototype, "handleClick", null);

__decorate([autobind], TextField.prototype, "handleButtonPress", null);

__decorate([autobind], TextField.prototype, "handleButtonRelease", null);
...
__decorate([autobind], TextField$2.prototype, "handleContextUpdate", null);
...
function (_React$PureComponent) {
  ...
  function ComboBox() {
    ...
    _this.subscriptions = [];
    _this.popoverScrollContainer = createRef();
    return _this;
  }
  ...
  _createClass(ComboBox, [{
    ...
    value: function componentDidMount() {
      var _this$props = this.props,
          ...
          actionsBefore = _this$props.actionsBefore,
          actionsAfter = _this$props.actionsAfter;
    ...
    value: function componentDidUpdate(_, prevState) {
      var _this$props2 = this.props,
          contentBefore = _this$props2.contentBefore,
          contentAfter = _this$props2.contentAfter,
          emptyState = _this$props2.emptyState;
      var _this$state = this.state,
          navigableOptions = _this$state.navigableOptions,
          popoverActive = _this$state.popoverActive,
          popoverWasActive = _this$state.popoverWasActive;
      this.subscriptions.forEach(function (subscriberCallback) {
        return subscriberCallback();
      });
      ...
      var popoverChanged = popoverActive === prevState.popoverActive;
    ...
    value: function render() {
      var _this$props3 = this.props,
          ...
          listTitle = _this$props3.listTitle,
          allowMultiple = _this$props3.allowMultiple,
          preferredPosition = _this$props3.preferredPosition,
          actionsBefore = _this$props3.actionsBefore,
          actionsAfter = _this$props3.actionsAfter,
          contentBefore = _this$props3.contentBefore,
          contentAfter = _this$props3.contentAfter,
      ...
      var scrollListenerMarkup = onEndReached && createElement("div", {
        ref: this.popoverScrollContainer
      });
    ...
    value: function handleDownArrow() {
      ...
      if (navigableOptions && selectedIndex === navigableOptions.length - 1 && onEndReached) {
        onEndReached();
      }
    ...
    value: function handleBlur() {
      ...
      this.setState({
        ...
        _this2.resetVisuallySelectedOptions();
      });
    }
  }, {
    key: "handleClick",
    value: function handleClick() {
      !this.state.popoverActive && this.setState({
        popoverActive: true
      });
    }
  }, {
    ...
    value: function handleScroll() {
      ...
      if (this.popoverScrollContainer.current) {
        var scrollContainer = this.popoverScrollContainer.current.parentElement;

        if (scrollContainer && scrollContainer.scrollTop > scrollContainer.scrollHeight - scrollContainer.offsetHeight - 1) {
          onEndReached();
        }
      }
    }
    ...
    key: "handleSelection",
    value: function handleSelection(newSelected) {
    ...
    key: "selectOptions",
    value: function selectOptions(selected) {
    ...
    key: "updateIndexOfSelectedOption",
    value: function updateIndexOfSelectedOption(newOptions) {
      var _this$state3 = this.state,
    ...
    key: "resetVisuallySelectedOptions",
    value: function resetVisuallySelectedOptions() {
    ...
    value: function handlePopoverOpen() {
      var _this$state4 = this.state,
          popoverActive = _this$state4.popoverActive,
          navigableOptions = _this$state4.navigableOptions;
      !popoverActive && navigableOptions && navigableOptions.length > 0 && this.setState({
        popoverActive: true,
        popoverWasActive: true
      });
    }
    ...
    key: "selectOptionAtIndex",
    value: function selectOptionAtIndex(newOptionIndex) {
      var _this3 = this;

      var _this$state7 = this.state,
          navigableOptions = _this$state7.navigableOptions,
          oldSelectedOption = _this$state7.selectedOption;
      ...
      this.setState({
        ...
        _this3.visuallyUpdateSelectedOption(newSelectedOption, oldSelectedOption);
      });
    }
  }, {
    key: "visuallyUpdateSelectedOption",
    value: function visuallyUpdateSelectedOption(newOption, oldOption) {
      if (oldOption) {
    ...
    value: function getSelectedOptionId() {
    ...
    value: function addScrollListener() {
      this.popoverScrollContainer.current && this.popoverScrollContainer.current.parentElement && addEventListener(this.popoverScrollContainer.current.parentElement, 'scroll', this.handleScroll, {
        passive: true
      });
    }
  }, {
    key: "removeScrollListener",
    value: function removeScrollListener() {
      this.popoverScrollContainer.current && this.popoverScrollContainer.current.parentElement && removeEventListener(this.popoverScrollContainer.current.parentElement, 'scroll', this.handleScroll);
    }
  }], [{
    key: "getDerivedStateFromProps",
...
__decorate([autobind], ComboBox.prototype, "subscribe", null);

__decorate([autobind], ComboBox.prototype, "unsubscribe", null);

__decorate([autobind], ComboBox.prototype, "handleDownArrow", null);

__decorate([autobind], ComboBox.prototype, "handleUpArrow", null);

__decorate([autobind], ComboBox.prototype, "handleEnter", null);

__decorate([autobind], ComboBox.prototype, "handleFocus", null);

__decorate([autobind], ComboBox.prototype, "handleBlur", null);

__decorate([autobind], ComboBox.prototype, "handleClick", null);

__decorate([autobind], ComboBox.prototype, "handleScroll", null);

__decorate([autobind], ComboBox.prototype, "handleSelection", null);

__decorate([autobind], ComboBox.prototype, "selectOptions", null);

__decorate([autobind], ComboBox.prototype, "updateIndexOfSelectedOption", null);

__decorate([autobind], ComboBox.prototype, "resetVisuallySelectedOptions", null);

__decorate([autobind], ComboBox.prototype, "handlePopoverClose", null);

__decorate([autobind], ComboBox.prototype, "handlePopoverOpen", null);

__decorate([autobind], ComboBox.prototype, "selectNextOption", null);

__decorate([autobind], ComboBox.prototype, "selectPreviousOption", null);

__decorate([autobind], ComboBox.prototype, "selectOptionAtIndex", null);

__decorate([autobind], ComboBox.prototype, "visuallyUpdateSelectedOption", null);

__decorate([autobind], ComboBox.prototype, "getSelectedOptionId", null);

__decorate([autobind], ComboBox.prototype, "addScrollListener", null);

__decorate([autobind], ComboBox.prototype, "removeScrollListener", null);
...
function (_React$PureComponent) {
  ...
  _createClass(Banner, [{
    ...
    value: function render() {
      ...
      }, createElement(ButtonGroup$1, null, createElement("div", {
...
function Backdrop(props) {
  ...
  var className = classNames$1(styles$t.Backdrop, belowNavigation && styles$t.belowNavigation);
  return createElement(Fragment, null, createElement(ScrollLock$1, null), createElement("div", {
    className: className,
    onClick: onClick,
...
function CalloutCard(_ref) {
  ...
  var buttonMarkup = secondaryActionMarkup ? createElement(ButtonGroup$1, null, primaryActionMarkup, secondaryActionMarkup) : primaryActionMarkup;
  var dismissButton = onDismiss ? createElement("div", {
  ...
  var imageClassName = classNames$1(styles$w.Image, onDismiss && styles$w.DismissImage);
...
function Checkbox$1(_ref) {
  var _ref$id = _ref.id,
      id = _ref$id === void 0 ? getUniqueID$4() : _ref$id,
      label = _ref.label,
      labelHidden = _ref.labelHidden,
      helpText = _ref.helpText,
      _ref$checked = _ref.checked,
...
__decorate([autobind], Collapsible.prototype, "bindNode", null);

__decorate([autobind], Collapsible.prototype, "bindHeightNode", null);

__decorate([autobind], Collapsible.prototype, "handleTransitionEnd", null);
  ...
  _createClass(ColorPicker, [{
    ...
    value: function render() {
      var _this$props = this.props,
          id = _this$props.id,
          color = _this$props.color,
          allowAlpha = _this$props.allowAlpha;
      var hue = color.hue,
          saturation = color.saturation,
          brightness = color.brightness,
    ...
    value: function handleHueChange(hue) {
      var _this$props2 = this.props,
          ...
          _this$props2$color$al = _this$props2$color.alpha,
          alpha = _this$props2$color$al === void 0 ? 1 : _this$props2$color$al,
          onChange = _this$props2.onChange;
      onChange({
        hue: hue,
        brightness: brightness,
    ...
    value: function handleAlphaChange(alpha) {
      var _this$props3 = this.props,
          ...
          brightness = _this$props3$color.brightness,
          saturation = _this$props3$color.saturation,
          onChange = _this$props3.onChange;
      onChange({
        hue: hue,
        brightness: brightness,
    ...
    value: function handleDraggerMove(_ref) {
      ...
      var _this$props4 = this.props,
          ...
          hue = _this$props4$color.hue,
          _this$props4$color$al = _this$props4$color.alpha,
          alpha = _this$props4$color$al === void 0 ? 1 : _this$props4$color$al,
...
__decorate([autobind], ColorPicker.prototype, "setColorNode", null);

__decorate([autobind], ColorPicker.prototype, "handleHueChange", null);

__decorate([autobind], ColorPicker.prototype, "handleAlphaChange", null);

__decorate([autobind], ColorPicker.prototype, "handleDraggerMove", null);
...
function (_React$PureComponent) {
  ...
  _createClass(TrapFocus, [{
    ...
    value: function handleTrappingChange() {
      var _this$props$trapping = this.props.trapping,
...
__decorate([autobind], TrapFocus.prototype, "setFocusTrapWrapper", null);

__decorate([autobind], TrapFocus.prototype, "handleBlur", null);
...
function (_React$PureComponent) {
  ...
  _createClass(Search, [{
    ...
    key: "handleDismiss",
    value: function handleDismiss(_ref) {
...
__decorate([autobind], Search.prototype, "handleDismiss", null);
  ...
  _createClass(SearchField, [{
    ...
    value: function handleClear() {
      var _this$props2 = this.props,
          ...
          onCancel = _this$props2$onCancel === void 0 ? noop$1 : _this$props2$onCancel,
          onChange = _this$props2.onChange;
      var input = this.input.current;
      onCancel();
...
__decorate([autobind], SearchField.prototype, "handleFocus", null);

__decorate([autobind], SearchField.prototype, "handleBlur", null);

__decorate([autobind], SearchField.prototype, "handleClear", null);

__decorate([autobind], SearchField.prototype, "handleChange", null);
...
function (_React$Component) {
  ...
  function Provider() {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(Provider).apply(this, arguments));
    _this.state = {
      // eslint-disable-next-line react/no-unused-state
      mobileView: _this.props.mobileView,
...
__decorate([autobind], Provider$1.prototype, "setMobileUserMenuProps", null);
...
function Link$1(_ref) {
  var url = _ref.url,
      ...
      id = _ref.id,
      monochrome = _ref.monochrome;
  var className = classNames$1(styles$H.Link, monochrome && styles$H.monochrome);
...
function Message(_ref) {
  ...
  return createElement("div", {
    ...
    vertical: true,
    spacing: "tight"
  }, createElement(TextContainer, null, createElement(Heading, null, title, badgeMarkup), createElement("p", null, description)), createElement(Link$1, {
    url: to
  }, linkContent), createElement(Button$2, {
    plain: true,
    onClick: onClick
  }, actionContent))));
}
...
function Menu(props) {
  ...
  return createElement(Popover, {
    activator: createElement("button", {
      type: "button",
...
var styles$K = {
  "UserMenu": "Polaris-UserMenu-UserMenu",
...
function UserMenu(_ref) {
  ...
  var activatorContentMarkup = createElement("div", {
    className: styles$K.UserMenu
  }, createElement(MessageIndicator, {
...
__decorate([autobind], TopBar.prototype, "handleFocus", null);

__decorate([autobind], TopBar.prototype, "handleBlur", null);
...
/*#__PURE__*/
function (_React$Component) {
  _inherits(Toast$$1, _React$Component);

  function Toast$$1() {
    _classCallCheck(this, Toast$$1);

    return _possibleConstructorReturn(this, _getPrototypeOf(Toast$$1).apply(this, arguments));
  }

  _createClass(Toast$$1, [{
    key: "componentDidUpdate",
    value: function componentDidUpdate() {
    ...
    value: function render() {
      ...
      var className = classNames$1(styles$M.Toast, error && styles$M.error);
      return createElement("div", {
        className: className
      }, createElement(KeypressListener, {
        keyCode: Key.Escape,
        handler: onDismiss
      }), content, dismissMarkup);
    }
  }, {
    ...
    value: function triggerDismissalTimeout() {
      var _this$props2 = this.props,
          ...
          duration = _this$props2$duration === void 0 ? DEFAULT_TOAST_DURATION : _this$props2$duration;
      this.clearDismissalTimeout();
...
function (_React$PureComponent) {
  ...
  _createClass(ToastManager, [{
    ...
    key: "updateToasts",
    value: function updateToasts() {
      var _this3 = this;

      var toastMessages = this.props.toastMessages;
      var targetInPos = 0;
      toastMessages.forEach(function (_toast, i) {
        var currentToast = _this3.toastNodes[i].current;
...
__decorate([autobind], ToastManager.prototype, "updateToasts", null);
...
/*#__PURE__*/
function (_React$Component) {
  _inherits(Loading$$1, _React$Component);

  function Loading$$1() {
    var _this;

    _classCallCheck(this, Loading$$1);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(Loading$$1).apply(this, arguments));
    _this.state = {
      progress: 0,
      step: INITIAL_STEP,
      animation: null
...
__decorate([debounce(15)], Loading$1.prototype, "ariaValuenow", null);
...
function Footer(_ref) {
  ...
  var actions = primaryActionButton || secondaryActionButtons ? createElement(ButtonGroup$1, null, secondaryActionButtons, primaryActionButton) : null;
  return createElement("div", {
...
function CloseButton(_ref) {
  var _ref$title = _ref.title,
      ...
      onClick = _ref.onClick;
  var className = classNames$1(styles$S.CloseButton, !title && styles$S.withoutTitle);
  return createElement("button", {
    onClick: onClick,
    className: className
  }, createElement(Icon$1, {
...
/*#__PURE__*/
function (_React$Component) {
  _inherits(Modal$$1, _React$Component);
  ...
  function Modal$$1() {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(Modal$$1).apply(this, arguments));
    _this.state = {
  ...
  _createClass(Modal$$1, [{
    ...
    value: function componentDidMount() {
      ...
      this.appBridgeModal = Modal.create(this.props.polaris.appBridge, this.transformProps());
      this.appBridgeModal.subscribe(Modal.Action.CLOSE, this.props.onClose);
      var open = this.props.open;

      if (open) {
        this.focusReturnPointNode = document.activeElement;
        this.appBridgeModal.dispatch(Modal.Action.OPEN);
      }
    }
  }, {
    key: "componentDidUpdate",
    value: function componentDidUpdate(prevProps) {
      ...
      if (wasOpen !== open) {
        if (open) {
          ...
          this.appBridgeModal.dispatch(Modal.Action.CLOSE);
        }
      }
    ...
    value: function handleExited() {
      ...
      if (this.focusReturnPointNode) {
        write(function () {
          return focusFirstFocusableNode(_this2.focusReturnPointNode, false);
        });
      }
    }
  }, {
    ...
    value: function transformProps() {
      ...
      var safeSize = size != null ? Modal.Size[size] : undefined;
      var srcPayload = {};
...
Modal$1.childContextTypes = contentContextTypes;
Modal$1.Dialog = Dialog;
Modal$1.Section = Section$3;

__decorate([autobind], Modal$1.prototype, "handleEntered", null);

__decorate([autobind], Modal$1.prototype, "handleExited", null);

__decorate([autobind], Modal$1.prototype, "handleIFrameLoad", null);

function isIframeModal(options) {
  return typeof options.url === 'string' || typeof options.path === 'string';
}

var Modal$2 = withAppProvider()(Modal$1);
...
function (_React$PureComponent) {
  ...
  _createClass(ContextualSaveBar, [{
    ...
    value: function render() {
      ...
      var discardActionMarkup = discardAction && createElement(Button$2, {
      ...
      var saveActionMarkup = saveAction && createElement(Button$2, {
        primary: true,
        url: saveAction.url,
    ...
    key: "toggleDiscardConfirmationModal",
    value: function toggleDiscardConfirmationModal() {
      this.setState(function (prevState) {
        return {
...
__decorate([autobind], ContextualSaveBar.prototype, "toggleDiscardConfirmationModal", null);
...
function (_React$PureComponent) {
  ...
  _createClass(Frame, [{
    ...
    value: function render() {
      ...
      }, createElement(Loading$1, null)) : null;
    ...
    key: "setGlobalRibbonHeight",
    value: function setGlobalRibbonHeight() {
      var globalRibbonContainer = this.globalRibbonContainer;
    ...
    key: "setGlobalRibbonRootProperty",
    value: function setGlobalRibbonRootProperty() {
      var globalRibbonHeight = this.state.globalRibbonHeight;
    ...
    key: "hideToast",
    value: function hideToast(_ref3) {
      var id = _ref3.id;
    ...
    key: "setContextualSaveBar",
    value: function setContextualSaveBar(props) {
      var showContextualSaveBar = this.state.showContextualSaveBar;
    ...
    key: "removeContextualSaveBar",
    value: function removeContextualSaveBar() {
    ...
    key: "handleNavigationDismiss",
    value: function handleNavigationDismiss() {
      var onNavigationDismiss = this.props.onNavigationDismiss;
    ...
    key: "setGlobalRibbonContainer",
    value: function setGlobalRibbonContainer(node) {
      this.globalRibbonContainer = node;
    }
  }, {
    key: "handleNavKeydown",
    value: function handleNavKeydown(event) {
      var key = event.key;
...
__decorate([autobind], Frame.prototype, "setGlobalRibbonHeight", null);

__decorate([autobind], Frame.prototype, "setGlobalRibbonRootProperty", null);

__decorate([autobind], Frame.prototype, "showToast", null);

__decorate([autobind], Frame.prototype, "hideToast", null);

__decorate([autobind], Frame.prototype, "setContextualSaveBar", null);

__decorate([autobind], Frame.prototype, "removeContextualSaveBar", null);

__decorate([autobind], Frame.prototype, "startLoading", null);

__decorate([autobind], Frame.prototype, "stopLoading", null);

__decorate([autobind], Frame.prototype, "handleResize", null);

__decorate([autobind], Frame.prototype, "handleClick", null);

__decorate([autobind], Frame.prototype, "handleFocus", null);

__decorate([autobind], Frame.prototype, "handleBlur", null);

__decorate([autobind], Frame.prototype, "handleNavigationDismiss", null);

__decorate([autobind], Frame.prototype, "setGlobalRibbonContainer", null);

__decorate([autobind], Frame.prototype, "handleNavKeydown", null);
...
function Cell(_ref) {
  ...
  var source = "caret".concat(direction === 'ascending' ? 'Up' : 'Down');
...
function Navigation(_ref) {
  ...
  }), pipMarkup, createElement(Button$2, {
    plain: true,
    icon: "chevronRight",
  ...
  _createClass(DataTable, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          _this$props$defaultSo = _this$props.defaultSortDirection,
          defaultSortDirection = _this$props$defaultSo === void 0 ? 'ascending' : _this$props$defaultSo,
      ...
      var _this$state = this.state,
          ...
          columnVisibilityData = _this$state.columnVisibilityData,
          heights = _this$state.heights,
          _this$state$sortedCol = _this$state.sortedColumnIndex,
          sortedColumnIndex = _this$state$sortedCol === void 0 ? initialSortColumnIndex : _this$state$sortedCol,
          _this$state$sortDirec = _this$state.sortDirection,
          sortDirection = _this$state$sortDirec === void 0 ? defaultSortDirection : _this$state$sortDirec,
          isScrolledFarthestLeft = _this$state.isScrolledFarthestLeft,
          isScrolledFarthestRight = _this$state.isScrolledFarthestRight;
    ...
    value: function handleResize() {
      ...
      this.setState(Object.assign({
        collapsed: collapsed,
        heights: []
      }, this.calculateColumnVisibilityData(collapsed)), function () {
    ...
    value: function resetScrollPosition() {
      ...
      if (scrollContainer) {
        var _this$state$preserved = this.state.preservedScrollPosition,
    ...
    value: function navigateTable(direction) {
      ...
      var _this$state2 = this.state,
          currentColumn = _this$state2.currentColumn,
          previousColumn = _this$state2.previousColumn,
          fixedColumnWidth = _this$state2.fixedColumnWidth;
      var scrollContainer = this.scrollContainer.current;
    ...
    value: function renderTotals(total, index) {
      ...
      var heights = this.state.heights;
      var _this$props$truncate = this.props.truncate,
    ...
    value: function defaultRenderRow(row, index) {
      ...
      var _this$props4 = this.props,
          ...
          totals = _this$props4.totals,
          footerContent = _this$props4.footerContent,
      ...
      var handleSort = function handleSort() {
        _this7.setState({
          ...
          if (onSort) {
            ...
            if (!truncate && _this7.scrollContainer.current) {
              var preservedScrollPosition = {
                left: _this7.scrollContainer.current.scrollLeft,
                top: window.scrollY
              };
...
__decorate([autobind, debounce()], DataTable.prototype, "handleResize", null);

__decorate([autobind], DataTable.prototype, "tallestCellHeights", null);

__decorate([autobind], DataTable.prototype, "resetScrollPosition", null);

__decorate([autobind], DataTable.prototype, "setHeightsAndScrollPosition", null);

__decorate([autobind], DataTable.prototype, "calculateColumnVisibilityData", null);

__decorate([autobind], DataTable.prototype, "scrollListener", null);

__decorate([autobind], DataTable.prototype, "navigateTable", null);

__decorate([autobind], DataTable.prototype, "renderTotals", null);

__decorate([autobind], DataTable.prototype, "defaultRenderRow", null);

__decorate([autobind], DataTable.prototype, "renderFooter", null);

__decorate([autobind], DataTable.prototype, "defaultOnSort", null);
  ...
  _createClass(Day, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          onHover = _this$props$onHover === void 0 ? noop : _this$props$onHover,
...
function Month(_ref) {
  ...
  return createElement("div", {
    ...
    className: className
  }, Months[month], " ", year), createElement("div", {
    role: "rowheader",
  ...
  _createClass(DatePicker, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          allowRange = _this$props.allowRange,
          multiMonth = _this$props.multiMonth,
          disableDatesBefore = _this$props.disableDatesBefore,
          disableDatesAfter = _this$props.disableDatesAfter,
          _this$props$weekStart = _this$props.weekStartsOn,
          weekStartsOn = _this$props$weekStart === void 0 ? Weekdays.Sunday : _this$props$weekStart,
          intl = _this$props.polaris.intl;
      var _this$state = this.state,
...
__decorate([autobind], DatePicker.prototype, "handleFocus", null);

__decorate([autobind], DatePicker.prototype, "resetFocus", null);

__decorate([autobind], DatePicker.prototype, "handleKeyUp", null);

__decorate([autobind], DatePicker.prototype, "setFocusDateAndHandleMonthChange", null);

__decorate([autobind], DatePicker.prototype, "handleDateSelection", null);

__decorate([autobind], DatePicker.prototype, "handleMonthChangeClick", null);

__decorate([autobind], DatePicker.prototype, "handleHover", null);
...
function (_React$Component) {
  ...
  _createClass(FileUpload, [{
    ...
    value: function render() {
      ...
      var imageClasses = classNames(styles$10.Image, size && size === 'extraLarge' && styles$10.sizeExtraLarge, size && size === 'large' && styles$10.sizeLarge);
      var extraLargeView = size === 'extraLarge' ? createElement(Stack, {
        ...
        className: imageClasses,
        src: AssetImageUpload,
        alt: ""
      }), createElement(Button$2, null, actionTitle), createElement(TextStyle, {
        variation: "subdued"
      }, actionHint)) : null;
      ...
      var mediumView = size === 'medium' ? createElement(Stack, {
        vertical: true,
        spacing: "tight"
      }, createElement(Link$1, null, actionTitle), createElement(Caption, null, createElement(TextStyle, {
        variation: "subdued"
      }, actionHint))) : null;
      ...
      return createElement("div", {
        className: styles$10.FileUpload
  ...
  _createClass(DropZone, [{
    ...
    value: function render() {
      var _this$state = this.state,
          ...
          overlayText = _this$state.overlayText,
          errorOverlayText = _this$state.errorOverlayText;
      var _this$props = this.props,
          label = _this$props.label,
          labelAction = _this$props.labelAction,
          labelHidden = _this$props.labelHidden,
      ...
      var classes = classNames(styles$11.DropZone, outline && styles$11.hasOutline, (active || dragging) && styles$11.isDragging, error && styles$11.hasError, size && size === 'extraLarge' && styles$11.sizeExtraLarge, size && size === 'large' && styles$11.sizeLarge, size && size === 'medium' && styles$11.sizeMedium, size && size === 'small' && styles$11.sizeSmall);
      var dragOverlay = (active || dragging) && !error && overlay ? createElement("div", {
        className: styles$11.Overlay
      }, createElement(Stack, {
        vertical: true,
        spacing: "tight"
      }, createElement(Icon$1, {
    ...
    value: function getValidatedFiles(files) {
      var _this$props2 = this.props,
          ...
          allowMultiple = _this$props2.allowMultiple,
          customValidator = _this$props2.customValidator;
      var acceptedFiles = [];
      var rejectedFiles = [];
    ...
    value: function handleDrop(event) {
      ...
      var _this$props4 = this.props,
          ...
          onDropAccepted = _this$props4.onDropAccepted,
          onDropRejected = _this$props4.onDropRejected,
          allowMultiple = _this$props4.allowMultiple;
      var numFiles = this.state.numFiles;
      ...
      var _this$getValidatedFil = this.getValidatedFiles(fileList),
    ...
    value: function handleDragEnter(event) {
      ...
      var _this$state2 = this.state,
          ...
          numFiles = _this$state2.numFiles;
      var _this$props5 = this.props,
          disabled = _this$props5.disabled,
          onDragEnter = _this$props5.onDragEnter,
          allowMultiple = _this$props5.allowMultiple;
      ...
      var _this$getValidatedFil2 = this.getValidatedFiles(fileList),
    ...
    value: function handleDragLeave(event) {
      ...
      var _this$props7 = this.props,
          ...
          onDragLeave = _this$props7.onDragLeave,
...
__decorate([autobind], DropZone.prototype, "triggerFileDialog", null);

__decorate([autobind], DropZone.prototype, "open", null);

__decorate([autobind, debounce(50, {
  trailing: true
})], DropZone.prototype, "adjustSize", null);

__decorate([autobind], DropZone.prototype, "getValidatedFiles", null);

__decorate([autobind], DropZone.prototype, "setNode", null);

__decorate([autobind], DropZone.prototype, "setInputNode", null);

__decorate([autobind], DropZone.prototype, "handleClick", null);

__decorate([autobind], DropZone.prototype, "handleDrop", null);

__decorate([autobind], DropZone.prototype, "handleDragEnter", null);

__decorate([autobind], DropZone.prototype, "handleDragOver", null);

__decorate([autobind], DropZone.prototype, "handleDragLeave", null);
  ...
  _createClass(EmptyState, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          action = _this$props.action,
          secondaryAction = _this$props.secondaryAction;
      var className = classNames(styles$13.EmptyState, imageContained && styles$13.imageContained);
      ...
      return createElement("div", {
        ...
        className: styles$13.DetailsContainer
      }, createElement("div", {
        className: styles$13.Details
        ...
        primary: true,
        size: 'large'
      }), secondaryActionMarkup)))), createElement("div", {
        className: styles$13.ImageContainer
      }, imageMarkup)));
    }
  }]);
...
function ExceptionList(_ref) {
  ...
  return createElement("ul", {
    className: styles$15.ExceptionList
  }, items);
}
...
function FooterHelp(_ref) {
  var children = _ref.children;
  return createElement("div", {
    className: styles$16.FooterHelp
  }, createElement("div", {
  ...
  _createClass(Form, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          _this$props$implicitS = _this$props.implicitSubmit,
          implicitSubmit = _this$props$implicitS === void 0 ? true : _this$props$implicitS,
...
function Group(_ref) {
  var children = _ref.children,
      ...
      title = _ref.title,
      helpText = _ref.helpText;
  var className = classNames(condensed ? styles$17.condensed : styles$17.grouped);
...
function (_React$PureComponent) {
  ...
  _createClass(FormLayout, [{
    ...
    value: function render() {
      var children = this.props.children;
      return createElement("div", {
        className: styles$17.FormLayout
...
function KeyboardKey(_ref) {
  ...
  return createElement("kbd", {
    className: styles$18.KeyboardKey
  }, key);
}
...
function AnnotatedSection(props) {
  ...
  return createElement("div", {
    className: styles$19.AnnotatedSection
  }, createElement("div", {
    className: styles$19.AnnotationWrapper
  }, createElement("div", {
    className: styles$19.Annotation
  }, createElement(TextContainer, null, createElement(Heading, null, title), descriptionMarkup && createElement("div", {
    className: styles$19.AnnotationDescription
  }, descriptionMarkup))), createElement("div", {
    className: styles$19.AnnotationContent
  }, children)));
}
...
function Section$4(_ref) {
  ...
  var className = classNames(styles$19.Section, secondary && styles$19['Section-secondary'], fullWidth && styles$19['Section-fullWidth'], oneHalf && styles$19['Section-oneHalf'], oneThird && styles$19['Section-oneThird']);
  return createElement("div", {
    className: className
  }, children);
}
...
function (_React$PureComponent) {
  ...
  _createClass(ContentList, [{
    ...
    value: function render() {
      ...
      var className = classNames(styles$1a.List, type && styles$1a[variationName('type', type)]);
...
/*#__PURE__*/
function (_React$PureComponent) {
  _inherits(Loading$$1, _React$PureComponent);

  function Loading$$1() {
    _classCallCheck(this, Loading$$1);

    return _possibleConstructorReturn(this, _getPrototypeOf(Loading$$1).apply(this, arguments));
  }
  ...
  _createClass(Loading$$1, [{
    ...
    value: function componentDidMount() {
      ...
      if (appBridge == null) {
        ...
        this.appBridgeLoading = Loading.create(appBridge);
        this.appBridgeLoading.dispatch(Loading.Action.START);
      }
    }
  }, {
    key: "componentWillUnmount",
    value: function componentWillUnmount() {
      ...
      if (appBridge == null) {
        ...
        this.appBridgeLoading.dispatch(Loading.Action.STOP);
      }
    }
  }, {
    key: "render",
...
Loading$2.contextTypes = frameContextTypes;
var Loading$3 = withAppProvider()(Loading$2);
...
function Indicator(_ref) {
  ...
  var className = classNames(styles$1b.Indicator, pulse && styles$1b.pulseIndicator);
  return createElement("span", {
    className: className
  });
}
  ...
  _createClass(BaseItem, [{
    ...
    value: function render() {
      ...
      var indicatorMarkup = hasNewChild ? createElement("span", {
        className: styles$1c.Indicator
      }, createElement(Indicator, {
        pulse: true
      })) : null;
      var badgeMarkup = badge || isNew ? createElement("div", {
        className: styles$1c.Badge
      }, createElement(Badge$1, {
        status: "new",
        size: "small"
      }, badge || intl.translate('Polaris.Badge.STATUS_LABELS.new'))) : null;
      var iconMarkup = iconBody ? createElement("span", {
      ...
      var itemContentMarkup = createElement(Fragment, null, iconMarkup, createElement("span", {
        className: styles$1c.Text
      }, label, indicatorMarkup), badgeMarkup);

      if (url == null) {
        var _className = classNames(styles$1c.Item, disabled && styles$1c['Item-disabled']);

        return createElement("li", {
          className: styles$1c.ListItem
      ...
      var secondaryActionMarkup = secondaryAction && createElement(UnstyledLink$1, {
        ...
        className: styles$1c.SecondaryAction,
        tabIndex: tabIndex,
        "aria-disabled": disabled,
      ...
      var itemClassName = classNames(styles$1c.Item, disabled && styles$1c['Item-disabled'], selected && subNavigationItems.length === 0 && styles$1c['Item-selected'], showExpanded && styles$1c.subNavigationActive);
      var secondaryNavigationMarkup = null;

      if (subNavigationItems.length > 0 && showExpanded) {
        var longestMatch = matchingSubNavigationItems.sort(function (_ref, _ref2) {
          var firstUrl = _ref.url;
          var secondUrl = _ref2.url;
          return secondUrl.length - firstUrl.length;
        })[0];
        secondaryNavigationMarkup = createElement("div", {
          className: styles$1c.SecondaryNavigation
      ...
      var className = classNames(styles$1c.ListItem, secondaryAction && styles$1c['ListItem-hasAction']);
      return createElement("li", {
        className: className
      }, createElement(UnstyledLink$1, {
        url: url,
    ...
    key: "getClickHandler",
    value: function getClickHandler(onClick) {
      var _this2 = this;

      return function (event) {
        var currentTarget = event.currentTarget;
        var subNavigationItems = _this2.props.subNavigationItems;
        var _this2$context = _this2.context,
            location = _this2$context.location,
            onNavigationDismiss = _this2$context.onNavigationDismiss;
...
__decorate([autobind], BaseItem.prototype, "handleResize", null);

__decorate([autobind, memoize()], BaseItem.prototype, "getClickHandler", null);
...
function (_React$Component) {
  ...
  _createClass(Section, [{
    ...
    value: function render() {
      ...
      var expanded = this.state.expanded;
      var className = classNames(styles$1c.Section, separator && styles$1c['Section-withSeparator'], fill && styles$1c['Section-fill']);
      var actionMarkup = action && createElement("button", {
        type: "button",
        className: styles$1c.Action,
      ...
      var sectionHeadingMarkup = title && createElement("li", {
        className: styles$1c.SectionHeading
      }, createElement("span", {
        className: styles$1c.Text
      }, title), actionMarkup);
      var itemsMarkup = items.map(function (item) {
        var onClick = item.onClick,
            label = item.label,
            rest = __rest(item, ["onClick", "label"]);
      ...
      var toggleClassName = classNames(styles$1c.Item, styles$1c.RollupToggle);
      ...
      var activeItemIndex = items.findIndex(function (item) {
        ...
        return rollup.activePath === item.url || item.url && rollup.activePath.startsWith(item.url) || (item.subNavigationItems ? item.subNavigationItems.some(function (_ref) {
          var itemUrl = _ref.url;
      ...
      var activeItemsMarkup = rollup && additionalItems.length > 0 && createElement("li", {
        className: styles$1c.RollupSection
...
__decorate([memoize()], Section$5.prototype, "handleClick", null);

__decorate([autobind], Section$5.prototype, "toggleViewAll", null);
...
__decorate([autobind], UserMenu$3.prototype, "handleToggle", null);
  ...
  _createClass(Navigation, [{
    ...
    value: function render() {
      ...
      var contextControlMarkup = contextControl && createElement("div", {
        className: styles$1c.ContextControl
      }, contextControl);
      return createElement("nav", {
        className: styles$1c.Navigation
      }, contextControlMarkup, createElement("div", {
        className: styles$1c.UserMenu
      }, userMenu), createElement(Scrollable$1, {
        className: styles$1c.PrimaryNavigation
      }, children));
    }
  }]);
...
function (_React$PureComponent) {
  ...
  function TooltipOverlay() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(TooltipOverlay).apply(this, arguments));
  }
...
__decorate([autobind], Tooltip.prototype, "setActivator", null);

__decorate([autobind], Tooltip.prototype, "handleFocus", null);

__decorate([autobind], Tooltip.prototype, "handleBlur", null);

__decorate([autobind], Tooltip.prototype, "handleMouseEnter", null);

__decorate([autobind], Tooltip.prototype, "handleMouseLeave", null);
...
function Pagination(_ref) {
  ...
  var className = classNames$1(styles$1f.Pagination, plain && styles$1f.plain);
...
function Action(_ref) {
  ...
  var iconMarkup = icon && createElement("span", {
    className: styles$1g.ActionIcon
  }, createElement(Icon$1, {
    source: icon
  }));
  ...
  var contentMarkup = iconMarkup || disclosureIconMarkup ? createElement("span", {
    className: styles$1g.ActionContent
  ...
  if (url) {
    return createElement(UnstyledLink$1, {
      ...
      url: url,
      onMouseUp: handleMouseUpByBlurring,
      className: styles$1g.Action,
      "aria-label": accessibilityLabel
    }, contentMarkup);
  }

  var className = classNames$1(styles$1g.Action, disabled && styles$1g.disabled, icon && children == null && styles$1g.iconOnly);
  return createElement("button", {
    key: children,
    className: className,
    onClick: onAction,
...
function (_React$Component) {
  ...
  function ActionGroup() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(ActionGroup).apply(this, arguments));
  }
  ...
  _createClass(ActionGroup, [{
    ...
    value: function render() {
      ...
      return createElement("div", {
        className: styles$1h.ActionGroup,
...
__decorate([autobind], ActionGroup.prototype, "handleClose", null);

__decorate([autobind], ActionGroup.prototype, "handleOpen", null);
...
function (_React$PureComponent) {
  ...
  _createClass(Header, [{
    ...
    value: function render() {
      ...
      var className = classNames(styles$1i.Header, titleHidden && styles$1i['Title-hidden'], pagination && styles$1i['Header-hasPagination'], separator && styles$1i['Header-hasSeparator'], breadcrumbs && breadcrumbs.length && styles$1i['Header-hasBreadcrumbs'], this.hasRollup && styles$1i['Header-hasRollup'], secondaryActions && secondaryActions.length && styles$1i['Header-hasSecondaryActions']);
      ...
      var titleMarkup = createElement("div", {
        className: styles$1i.TitleAndRollup
      }, createElement("div", {
    ...
    value: function renderRollupAction() {
      ...
      var rollupMarkup = this.hasRollup ? createElement("div", {
        className: styles$1i.Rollup
      }, createElement(Popover, {
        active: rollupOpen,
        onClose: this.handleRollupToggle,
        activator: createElement(Button$2, {
          plain: true,
          icon: "horizontalDots",
    ...
    value: function renderSecondaryActions() {
      ...
      var openActionGroup = this.state.openActionGroup;
      var _this$props3 = this.props,
          _this$props3$secondar = _this$props3.secondaryActions,
          secondaryActions = _this$props3$secondar === void 0 ? [] : _this$props3$secondar,
          _this$props3$actionGr = _this$props3.actionGroups,
          actionGroups = _this$props3$actionGr === void 0 ? [] : _this$props3$actionGr;
      ...
      var actionGroupsMarkup = actionGroups.length > 0 ? actionGroups.map(function (_ref, index) {
        var title = _ref.title,
            ...
            details = _ref.details;
        return createElement("div", {
          className: styles$1i.IndividualAction,
          ...
          actions: actions,
          details: details,
          onOpen: _this2.handleActionGroupOpen,
          onClose: _this2.handleActionGroupClose,
          active: title === openActionGroup
        }));
      }) : null;
      return createElement("div", {
        className: styles$1i.SecondaryActions
      }, createElement("div", {
        className: styles$1i.IndividualActions
...
__decorate([autobind], Header$2.prototype, "renderRollupAction", null);

__decorate([autobind], Header$2.prototype, "renderSecondaryActions", null);

__decorate([autobind], Header$2.prototype, "handleRollupToggle", null);

__decorate([autobind], Header$2.prototype, "handleActionGroupClose", null);

__decorate([autobind], Header$2.prototype, "handleActionGroupOpen", null);
...
function (_React$PureComponent) {
  ...
  _createClass(Page, [{
    ...
    value: function render() {
      ...
      var className = classNames(styles$1j.Page, fullWidth && styles$1j.fullWidth, singleColumn && styles$1j.singleColumn);
    ...
    value: function transformBreadcrumbs() {
      ...
      if (breadcrumbs != null && breadcrumbs.length > 0) {
        ...
        if (callback != null) {
          button.subscribe(Button.Action.CLICK, callback);
        }
...
function PageActions(_ref) {
  ...
  var secondaryActionsMarkup = secondaryActions ? createElement(ButtonGroup$1, null, buttonsFrom(secondaryActions)) : null;
...
function (_React$PureComponent) {
  ...
  _createClass(RangeSlider, [{
    ...
    value: function render() {
      ...
      var className = classNames(styles$1l.RangeSlider, error && styles$1l.error, disabled && styles$1l.disabled);
      return createElement(Labelled, {
        id: id,
        label: label,
        error: error,
...
__decorate([autobind], RangeSlider.prototype, "handleChange", null);
...
__decorate([autobind], Sticky.prototype, "setPlaceHolderNode", null);

__decorate([autobind], Sticky.prototype, "setStickyNode", null);

__decorate([autobind], Sticky.prototype, "handlePositioning", null);

__decorate([autobind], Sticky.prototype, "adjustPlaceHolderNode", null);
...
function (_React$PureComponent) {
  ...
  _createClass(BulkActionButton, [{
    ...
    value: function render() {
      ...
      var className = classNames$1(styles$1o.Button, disabled && styles$1o.disabled);
      return createElement("button", {
        className: className,
        onClick: onAction,
        onMouseUp: handleMouseUpByBlurring,
...
function (_React$PureComponent) {
  ...
  _createClass(BulkActions, [{
    ...
    value: function render() {
      ...
      var paginatedSelectAllActionMarkup = paginatedSelectAllAction ? createElement(Button$2, {
      ...
      var cancelButtonClassName = classNames(styles$1o.Button, styles$1o['Button-cancel']);
      ...
      var promotedActionsMarkup = promotedActions && numberOfPromotedActionsToRender > 0 ? _toConsumableArray(promotedActions).slice(0, numberOfPromotedActionsToRender).map(function (action, index) {
        return createElement(BulkActionButton, Object.assign({}, action, {
          key: index,
...
__decorate([autobind], BulkActions.prototype, "setLargeScreenButtonsNode", null);

__decorate([autobind], BulkActions.prototype, "setContainerNode", null);

__decorate([autobind], BulkActions.prototype, "setMoreActionsNode", null);

__decorate([autobind], BulkActions.prototype, "setSelectMode", null);

__decorate([autobind], BulkActions.prototype, "toggleSmallScreenPopover", null);

__decorate([autobind], BulkActions.prototype, "toggleLargeScreenPopover", null);

__decorate([autobind, debounce(50, {
  trailing: true
})], BulkActions.prototype, "handleResize", null);

__decorate([autobind], BulkActions.prototype, "handleMeasurement", null);
...
function Tag(_ref) {
  var children = _ref.children,
      ...
      intl = _ref.polaris.intl;
  var className = classNames$1(disabled && styles$1p.disabled, styles$1p.Tag);
  ...
  _createClass(DateSelector, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          dateOptionType = _this$props.dateOptionType,
          intl = _this$props.polaris.intl;
      var _this$state = this.state,
          selectedDate = _this$state.selectedDate,
          datePickerMonth = _this$state.datePickerMonth,
          datePickerYear = _this$state.datePickerYear,
          userInputDateError = _this$state.userInputDateError;
    ...
    value: function handleDateFilterOptionsChange(newOption) {
      var _this$props2 = this.props,
          ...
          filterMinKey = _this$props2.filterMinKey,
          filterMaxKey = _this$props2.filterMaxKey;
      var _this$state2 = this.state,
          initialConsumerFilterKey = _this$state2.initialConsumerFilterKey,
    ...
    value: function handleDateBlur() {
      var _this$props3 = this.props,
          ...
          onFilterValueChange = _this$props3.onFilterValueChange;
...
__decorate([autobind], DateSelector.prototype, "handleDateFilterOptionsChange", null);

__decorate([autobind], DateSelector.prototype, "handleDateFieldChange", null);

__decorate([autobind], DateSelector.prototype, "handleDateBlur", null);

__decorate([autobind], DateSelector.prototype, "handleDatePickerChange", null);

__decorate([autobind], DateSelector.prototype, "handleDatePickerMonthChange", null);
...
function (_React$PureComponent) {
  ...
  function FilterValueSelector() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(FilterValueSelector).apply(this, arguments));
  }
...
__decorate([autobind], FilterValueSelector.prototype, "handleOperatorOptionChange", null);
...
function (_React$PureComponent) {
  ...
  _createClass(FilterCreator, [{
    ...
    value: function render() {
      ...
      var activator = createElement(Button$2, {
      ...
      var addFilterButtonMarkup = selectedFilter ? createElement(Button$2, {
...
__decorate([autobind], FilterCreator.prototype, "handleButtonFocus", null);

__decorate([autobind], FilterCreator.prototype, "togglePopover", null);

__decorate([autobind], FilterCreator.prototype, "handleFilterKeyChange", null);

__decorate([autobind], FilterCreator.prototype, "handleFilterValueChange", null);

__decorate([autobind], FilterCreator.prototype, "handleAddFilter", null);
...
function (_React$Component) {
  ...
  function FilterControl() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(FilterControl).apply(this, arguments));
  }
  ...
  _createClass(FilterControl, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          additionalAction = _this$props.additionalAction,
          ...
          onSearchBlur = _this$props.onSearchBlur,
          onSearchChange = _this$props.onSearchChange,
          intl = _this$props.polaris.intl,
          _this$props$context = _this$props.context,
          selectMode = _this$props$context.selectMode,
          resourceName = _this$props$context.resourceName;
      ...
      var appliedFiltersMarkup = appliedFilters.map(function (appliedFilter) {
        var activeFilterLabel = _this.getFilterLabel(appliedFilter);
        ...
        return createElement("li", {
          ...
          onRemove: _this.getRemoveFilterCallback(filterId),
          disabled: selectMode
        }, activeFilterLabel));
      });
    ...
    value: function handleAddFilter(newFilter) {
      var _this$props2 = this.props,
          onFiltersChange = _this$props2.onFiltersChange,
    ...
    value: function getRemoveFilterCallback(filterId) {
      ...
      return function () {
        _this2.handleRemoveFilter(filterId);
      };
    }
  }, {
...
__decorate([autobind], FilterControl.prototype, "handleAddFilter", null);

__decorate([memoize()], FilterControl.prototype, "getRemoveFilterCallback", null);
  ...
  _createClass(Item, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          url = _this$props.url,
          media = _this$props.media,
          shortcutActions = _this$props.shortcutActions,
          ariaControls = _this$props.ariaControls,
          ariaExpanded = _this$props.ariaExpanded,
          _this$props$persistAc = _this$props.persistActions,
          persistActions = _this$props$persistAc === void 0 ? false : _this$props$persistAc,
          intl = _this$props.polaris.intl,
          accessibilityLabel = _this$props.accessibilityLabel,
          _this$props$context = _this$props.context,
          selectable = _this$props$context.selectable,
          selectMode = _this$props$context.selectMode,
          loading = _this$props$context.loading;
      var _this$state = this.state,
      ...
      if (shortcutActions && !loading) {
        if (persistActions) {
          actionsMarkup = createElement("div", {
            ...
            onClick: stopPropagation
          }, createElement(ButtonGroup$1, null, buttonsFrom(shortcutActions, {
            size: 'slim',
            plain: true
          })));
...
__decorate([autobind], Item$7.prototype, "setNode", null);

__decorate([autobind], Item$7.prototype, "handleAnchorFocus", null);

__decorate([autobind], Item$7.prototype, "handleFocusedBlur", null);

__decorate([autobind], Item$7.prototype, "handleFocus", null);

__decorate([autobind], Item$7.prototype, "handleBlur", null);

__decorate([autobind], Item$7.prototype, "handleMouseDown", null);

__decorate([autobind], Item$7.prototype, "handleLargerSelectionArea", null);

__decorate([autobind], Item$7.prototype, "handleSelection", null);

__decorate([autobind], Item$7.prototype, "handleClick", null);

__decorate([autobind], Item$7.prototype, "handleKeypress", null);

__decorate([autobind], Item$7.prototype, "handleActionsClick", null);

__decorate([autobind], Item$7.prototype, "handleCloseRequest", null);
...
function (_React$Component) {
  ...
  _createClass(ResourceList, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          items = _this$props.items,
          promotedBulkActions = _this$props.promotedBulkActions,
          bulkActions = _this$props.bulkActions,
          filterControl = _this$props.filterControl,
          loading = _this$props.loading,
          _this$props$showHeade = _this$props.showHeader,
          showHeader = _this$props$showHeade === void 0 ? false : _this$props$showHeade,
          sortOptions = _this$props.sortOptions,
          sortValue = _this$props.sortValue,
          alternateTool = _this$props.alternateTool,
      ...
      var selectButtonMarkup = this.selectable ? createElement("div", {
        ...
        disabled: selectMode,
        icon: selectIcon // eslint-disable-next-line react/jsx-no-bind
        ,
      ...
      var headerMarkup = (showHeader || needsHeader) && this.listRef.current && createElement("div", {
      ...
      var emptyStateMarkup = filterControl && !this.itemsExist() && !loading ? createElement("div", {
    ...
    value: function setLoadingPosition() {
      if (this.listRef.current != null) {
        ...
        var overlay = this.listRef.current.getBoundingClientRect();
    ...
    value: function handleToggleAll() {
      var _this$props5 = this.props,
          ...
          _this$props5$idForIte = _this$props5.idForItem,
          idForItem = _this$props5$idForIte === void 0 ? defaultIdForItem : _this$props5$idForIte;
    ...
    get: function get$$1() {
      var _this$props8 = this.props,
          _this$props8$resource = _this$props8.resourceName,
          resourceName = _this$props8$resource === void 0 ? this.defaultResourceName : _this$props8$resource,
...
__decorate([autobind], ResourceList.prototype, "bulkSelectState", null);

__decorate([autobind], ResourceList.prototype, "headerTitle", null);

__decorate([autobind], ResourceList.prototype, "bulkActionsLabel", null);

__decorate([autobind], ResourceList.prototype, "bulkActionsAccessibilityLabel", null);

__decorate([autobind], ResourceList.prototype, "paginatedSelectAllText", null);

__decorate([autobind], ResourceList.prototype, "paginatedSelectAllAction", null);

__decorate([debounce(50), autobind], ResourceList.prototype, "handleResize", null);

__decorate([autobind], ResourceList.prototype, "setLoadingPosition", null);

__decorate([autobind], ResourceList.prototype, "handleSelectAllItemsInStore", null);

__decorate([autobind], ResourceList.prototype, "renderItem", null);

__decorate([autobind], ResourceList.prototype, "handleSelectionChange", null);

__decorate([autobind], ResourceList.prototype, "handleSelectMode", null);

__decorate([autobind], ResourceList.prototype, "handleToggleAll", null);
...
/*#__PURE__*/
function (_React$PureComponent) {
  _inherits(ResourcePicker$$1, _React$PureComponent);

  function ResourcePicker$$1() {
    var _this;

    _classCallCheck(this, ResourcePicker$$1);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(ResourcePicker$$1).apply(this, arguments));
    _this.focusReturnPoint = null;
    return _this;
  }

  _createClass(ResourcePicker$$1, [{
    key: "componentDidMount",
    value: function componentDidMount() {
      if (this.props.polaris.appBridge == null) {
        return;
      ...
      var appBridge = this.props.polaris.appBridge;
      this.appBridgeResourcePicker = ResourcePicker.create(appBridge, {
        resourceType: ResourcePicker.ResourceType[resourceType],
        options: {
      ...
      if (onSelection != null) {
        this.appBridgeResourcePicker.subscribe(ResourcePicker.Action.SELECT, function (_ref) {
      ...
      if (onCancel != null) {
        this.appBridgeResourcePicker.subscribe(ResourcePicker.Action.CANCEL, onCancel);
      }

      if (open) {
        this.focusReturnPoint = document.activeElement;
        this.appBridgeResourcePicker.dispatch(ResourcePicker.Action.OPEN);
      }
    }
  }, {
    key: "componentDidUpdate",
    value: function componentDidUpdate(prevProps) {
      ...
      if (wasOpen !== open) {
        if (open) {
          ...
          this.appBridgeResourcePicker.dispatch(ResourcePicker.Action.CLOSE);
        }
      }
...
var ResourcePicker$2 = withAppProvider()(ResourcePicker$1);
...
__decorate([autobind], Item$9.prototype, "setFocusedNode", null);
...
function (_React$PureComponent) {
  ...
  _createClass(List, [{
    ...
    key: "handleKeypress",
    value: function handleKeypress(event) {
      var _this$props$onKeyPres = this.props.onKeyPress,
          onKeyPress = _this$props$onKeyPres === void 0 ? noop : _this$props$onKeyPres;
      onKeyPress(event);
    }
  }]);
...
__decorate([autobind], List.prototype, "handleKeypress", null);
...
function (_React$PureComponent) {
  ...
  _createClass(Tab, [{
    ...
    value: function render() {
      ...
      var className = classNames(styles$1u.Tab, selected && styles$1u['Tab-selected']);
      var tabIndex;
      ...
      return createElement("li", {
        role: "presentation",
        className: styles$1u.TabContainer,
        ref: this.setNode
      }, markup);
    }
  }, {
...
function (_React$PureComponent) {
  ...
  _createClass(TabMeasurer, [{
    ...
    value: function render() {
      ...
      var classname = classNames(styles$1u.Tabs, styles$1u.TabMeasurer);
      return createElement("div", {
        className: classname,
        ref: this.setContainerNode
      }, createElement(EventListener, {
    ...
    value: function handleMeasurement() {
      ...
      var tabMeasurerNode = findDOMNode(this);
...
function (_React$PureComponent) {
  ...
  _createClass(Tabs, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      ...
      var _this$state = this.state,
          disclosureWidth = _this$state.disclosureWidth,
    ...
    value: function render() {
      ...
      var classname = classNames(styles$1u.Tabs, fitted && styles$1u.fitted, disclosureActivatorVisible && styles$1u.fillSpace);
      var disclosureTabClassName = classNames(styles$1u.DisclosureTab, disclosureActivatorVisible && styles$1u['DisclosureTab-visible']);
      var activator = createElement("button", {
        tabIndex: -1,
        className: styles$1u.DisclosureActivator,
    ...
    value: function handleKeyPress(event) {
      var _this$state3 = this.state,
          tabToFocus = _this$state3.tabToFocus,
          visibleTabs = _this$state3.visibleTabs,
          hiddenTabs = _this$state3.hiddenTabs;
    ...
    value: function handleFocus(event) {
      var _this$props2 = this.props,
          selected = _this$props2.selected,
          tabs = _this$props2.tabs; // If we are explicitly focusing one of the non-selected tabs, use it
      // move the focus to it

      var target = event.target;

      if (target.classList.contains(styles$1u.Tab) || target.classList.contains(styles$1u.Item)) {
        var tabToFocus = -1;
      ...
      if (target.classList.contains(styles$1u.DisclosureActivator)) {
        return;
      ...
      if (!relatedTarget.classList.contains(styles$1u.Tab) && !relatedTarget.classList.contains(styles$1u.Item) && !relatedTarget.classList.contains(styles$1u.DisclosureActivator)) {
        this.setState({
          tabToFocus: selected
        });
      }
    ...
    value: function handleTabClick(id) {
      var _this$props4 = this.props,
          ...
          onSelect = _this$props4$onSelect === void 0 ? noop : _this$props4$onSelect;
...
__decorate([autobind], Tabs.prototype, "handleKeyPress", null);

__decorate([autobind], Tabs.prototype, "renderTabMarkup", null);

__decorate([autobind], Tabs.prototype, "handleFocus", null);

__decorate([autobind], Tabs.prototype, "handleBlur", null);

__decorate([autobind], Tabs.prototype, "handleDisclosureActivatorClick", null);

__decorate([autobind], Tabs.prototype, "handleClose", null);

__decorate([autobind], Tabs.prototype, "handleMeasurement", null);

__decorate([autobind], Tabs.prototype, "handleTabClick", null);
...
function Thumbnail(_ref) {
  var source = _ref.source,
      ...
      _ref$size = _ref.size,
      size = _ref$size === void 0 ? 'medium' : _ref$size;
  var className = classNames(styles$1v.Thumbnail, size && styles$1v[variationName('size', size)]);
  return createElement("span", {
    className: className
  }, createElement(Image, {
    alt: alt,
    source: source,
    className: styles$1v.Image
  }));
}
...
/*#__PURE__*/
function (_React$PureComponent) {
  _inherits(Toast$$1, _React$PureComponent);
  ...
  function Toast$$1() {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(Toast$$1).apply(this, arguments));
    _this.id = createId();
    return _this;
  }
  ...
  _createClass(Toast$$1, [{
    ...
    value: function componentDidMount() {
      ...
      if (appBridge == null) {
        ...
        this.appBridgeToast = Toast.create(appBridge, {
          message: content,
          duration: duration,
          isError: error
        });
        this.appBridgeToast.subscribe(Toast.Action.CLEAR, onDismiss);
        this.appBridgeToast.dispatch(Toast.Action.SHOW);
      }
    }
  }, {
    key: "componentWillUnmount",
...
Toast$2.contextTypes = frameContextTypes;
var Toast$3 = withAppProvider()(Toast$2);
  ...
  _createClass(SkeletonPage, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          breadcrumbs = _this$props.breadcrumbs;
      var className = classNames(styles$1y.Page, fullWidth && styles$1y.fullWidth, singleColumn && styles$1y.singleColumn);
...
function ProgressBar(_ref) {
  var _ref$progress = _ref.progress,
      ...
      size = _ref$size === void 0 ? 'medium' : _ref$size,
      intl = _ref.polaris.intl;
  var className = classNames(styles$1z.ProgressBar, size && styles$1z[variationName('size', size)]);
  ...
  return createElement("div", {
    ...
    className: styles$1z.Progress,
    value: parsedProgress,
    max: "100"
  }), createElement("div", {
    className: styles$1z.Indicator,
    style: {
...
export { Key, contentContextTypes, AccountConnection, ActionList, AppProvider, polarisAppProviderContextTypes as polarisContextTypes, createAppProviderContext, createPolarisContext, withAppProvider, Autocomplete$1 as Autocomplete, Avatar$1 as Avatar, Badge$1 as Badge, Banner, Backdrop, Breadcrumbs, Button$2 as Button, buttonFrom, buttonsFrom, ButtonGroup$1 as ButtonGroup, CalloutCard, Caption, Card, Checkbox$2 as Checkbox, ChoiceList$1 as ChoiceList, Collapsible$1 as Collapsible, ColorPicker, rgbToHex, rgbToHsb, rgbToHsl, hsbToRgb, hsbToHex, rgbString, rgbaString, Connected, ContextualSaveBar$2 as ContextualSaveBar, DataTable$1 as DataTable, DatePicker$1 as DatePicker, DescriptionList, DisplayText, DropZone$1 as DropZone, EmptySearchResult$1 as EmptySearchResult, EmptyState, EventListener, ExceptionList, Focus, TrapFocus, FooterHelp, Form, FormLayout, Frame$1 as Frame, DEFAULT_TOAST_DURATION, Heading, Icon$1 as Icon, Image, InlineError, KeyboardKey, KeypressListener, Label, Labelled, Layout, Link$1 as Link, ContentList as List, Loading$3 as Loading, Modal$2 as Modal, OptionList$1 as OptionList, Navigation$2 as Navigation, isNavigationItemActive, Page$1 as Page, PageActions, Pagination$1 as Pagination, Popover, CloseSource as PopoverCloseSource, Portal, RadioButton, RangeSlider$1 as RangeSlider, ResourceList$1 as ResourceList, FilterType, ResourcePicker$2 as ResourcePicker, Scrollable$1 as Scrollable, ScrollLock$1 as ScrollLock, Select, SettingToggle, Spinner$1 as Spinner, Stack, Sticky, Subheading, Tabs, Tag$1 as Tag, TextContainer, TextField$1 as TextField, TextStyle, Thumbnail, ThemeProvider, Toast$3 as Toast, Tooltip, TopBar$1 as TopBar, Truncate, UnstyledLink$1 as UnstyledLink, VisuallyHidden, SkeletongBodyText as SkeletonPage, SkeletonBodyText, SkeletonDisplayText, ProgressBar$1 as ProgressBar, Indicator, withContext, withRef };
